...
public class CondicaoSeguradoraConfiguration : BaseEntityConfiguration<CondicaoSeguradora>
{
    public override void Configure(EntityTypeBuilder<CondicaoSeguradora> builder)
    {
