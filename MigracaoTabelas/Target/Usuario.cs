...
public class Usuario
{
    ...
    public Usuario(string usuarioLogin, string nome, string email, ulong? perfilId, ulong pontoAtendimentoId, StatusUsuario status = StatusUsuario.Ativo)
    {
    ...
    {
        return new Usuario(usuarioLogin, nome, email, perfilId, pontoAtendimentoId, status);
    }
