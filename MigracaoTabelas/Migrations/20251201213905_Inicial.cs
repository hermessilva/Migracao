        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    iof = table.Column<decimal>(type: "decimal(5,4)", nullable: false, comment: "Porcentual de IOF cobrado no seguro"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DescricaoCreditoComissaoParcela = table.Column<string>(type: "longtext", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<ulong>(type: "bigint unsigned", nullable: false, comment: "Identificador único do registro na tabela")
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    usuario_id = table.Column<ulong>(type: "bigint unsigned", nullable: false, comment: "Chave estrangeira referenciando a tabela usuario que realizou a ação"),
                    agencia_id = table.Column<ulong>(type: "bigint unsigned", nullable: false, comment: "Chave estrangeira referenciando a tabela agencia onde a ação foi realizada"),
                    modulo = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false, comment: "Nome do módulo ou área do sistema onde a operação foi realizada"),
                    operacao = table.Column<string>(type: "enum('Insert','Delete','Update')", nullable: false, comment: "Tipo da operação realizada: Insert (inserção), Delete (exclusão) ou Update (atualização)"),
                    antes = table.Column<string>(type: "longtext", nullable: false, comment: "Dados do registro antes da alteração em formato JSON ou serializado"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dps = table.Column<bool>(type: "tinyint(1)", nullable: true, comment: "Indica se foi exigida Declaração Pessoal de Saúde (true/false)"),
